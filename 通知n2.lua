...
function Nofitication:Notify(nofdebug, middledebug, all)
    ...
    Outline_A.BackgroundColor3 = getRainbowColor()
    ...
    WindowTitle.Position = UDim2.new(0, 6, 0, 2)
    ...
    WindowDescription.Position = UDim2.new(0, 6, 0, 24)
    ...
    WindowDescription.TextColor3 = Color3.fromRGB(240, 240, 240)
    ...
    if SelectedType == "default" then
        local function ORBHB_fake_script()
            ...
            local colorConn = game:GetService("RunService").Heartbeat:Connect(function()
                Outline_A.BackgroundColor3 = getRainbowColor()
            end)
    ...
    elseif SelectedType == "option" then
        ...
        Uncheck.Position = UDim2.new(0, 5, 0, 52)
        ...
        Check.Position = UDim2.new(0, 22, 0, 52)
